...
if {use_nwd!r}:
    ...
    patch_all_nwd(c_base=12.0, k=1.0, alpha=0.5, use_sa=True, use_nwd_nms=False, nwd_min=0.0)
    print("[NWD] Patched loss and TAL with SA-NWD (c_base=12.0, k=1.0, alpha=0.5, nwd_min=0.0)")
else:
