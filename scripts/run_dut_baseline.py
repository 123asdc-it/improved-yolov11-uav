"""run_dut_baseline.py — DUT Anti-UAV Baseline (YOLOv11n + CIoU, no NWD)"""
import os, sys, json
...
print('[DUT Baseline] YOLOv11n + CIoU, no NWD patch')
...
result = {
    'name': 'DUT Baseline (YOLOv11n + CIoU)', 'exp': EXP_NAME,
